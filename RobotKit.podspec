...
Pod::Spec.new do |s|
  s.name             = "RobotKit"
  s.version          = "0.1.0"
  s.summary          = "A short description of RobotKit."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/RobotKit"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Hans Knoechel" => "hans.knoechel@hs-osnabrueck.de" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/RobotKit.git", :tag => s.version.to_s }
